...
<title>Kho Sách - Trang đăng nhập</title>
</head>
<body>
	...
	<!-- <nav aria-label="breadcrumb">
	  <ol class="breadcrumb mg-b-0">
	    <li class="breadcrumb-item"><a style="color: #7987a1" href="#">Trang chu</a></li>
	    <li class="breadcrumb-item active" aria-current="page" style="color:#ff5800">Đăng nhập</li>
	  </ol>
	</nav> -->
        ...
        <div class="media align-items-stretch justify-content-center ht-100p pos-relative">
          ...
          <div class="sign-wrapper mg-lg-l-50 mg-xl-l-60">
            <div class="wd-100p">
              ...
              <p style="color: #f55800" class="tx-color-03 tx-18 mg-b-40">Chào mừng đến với kho sách. Đăng nhập ngay! </p>
			<form action="j_spring_security_check" method="post">
              <div class="form-group">
                <label>Email/TenDangNhap</label>
                <input name="j_username"  class="form-control" placeholder="VinhTD">
              </div>
              <div class="form-group">
