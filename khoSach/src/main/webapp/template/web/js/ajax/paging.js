			...
			success : function(result) {
	            ...
	            if (listSize > 0) {
	            	for (i = 0; i < listSize; i++) {
	            		var product ='<a href="/khoSach/chi-tiet-san-pham?id='+result[i].productID+'"style="margin: 10px;">';
	            		product +='<div class="product-single text-center"><div class="product-img"><img style="padding-top: 20px" src="/khoSach/image/product/'+result[i].thumbnail+'">';
