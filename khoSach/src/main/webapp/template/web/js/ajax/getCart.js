		...
		$.ajax({
			...
			success : function(result) {
	            ...
	            if (listSize > 0) {
	            	...
	            	$(".header-chart-dropdown").append(	'<div class="chart-checkout"><p>	Tổng tiền<span style="text-transform: uppercase;">'	+total+' VND</span>	</p> <button type="button" class="btn btn-default"><a href="/khoSach/gio-hang">Xem giỏ hàng</a>	</button></div>');
	            }
