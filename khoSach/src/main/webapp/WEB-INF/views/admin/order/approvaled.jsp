...
<title>Kho Sách - Quản trị - Đơn hàng - Danh sách đơn hàng đã duyệt</title>
</head>
<body>
	<div class="container-fluid">
		<h1 style="margin-top: -8px; color: #000"
			class="h3 mb-2 text-gray-800">Danh sách đơn hàng đã duyệt</h1>
				<div class="tab ">
							...
							<c:forEach items="${listOrder}" var="order">
								...
								<tr id="trGC_${order.orderID}">
									...
									<td><a style="margin-right: 3px;" class="btn btn-info"
										...
										onclick="updateStatusOrder(${order.orderID},${3})" 
