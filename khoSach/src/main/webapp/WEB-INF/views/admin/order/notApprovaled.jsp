...
<title>Kho Sách - Quản trị - Đơn hàng - Danh sách đơn hàng chưa duyệt</title>
</head>
<body>
	<div class="container-fluid">
		<h1 style="margin-top: -8px; color: #000"
			class="h3 mb-2 text-gray-800">Danh sách đơn hàng chưa duyệt</h1>
				<div class="tab ">
						...
						<tbody>
							<c:forEach items="${listOrder}" var="order">
								...
								<tr id="trGC_${order.orderID}">
									...
									<td><a href="" style="margin-right: 3px;" class="btn btn-info"
										...
										onclick="updateStatusOrder(${order.orderID},${2 })" 
	...
	<script src="<c:url value='/template/admin/js/ajax/orderDetailCheckApp.js' />"></script>
</body>
</html>