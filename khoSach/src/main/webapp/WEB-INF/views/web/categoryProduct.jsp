...
<title>Kho sách - Trang danh sách sản phẩm</title>
</head>
<body>
								...
								<ul class="ty-product-filters" id="content_32_29">
									<li>
										<ul id="ranges_32_29" class="ty-product-filters-sub">
											...
											<li><label class="check">Kim Đồng <input
													type="checkbox"> <span class="checkmark"></span>
											</label></li>
											<li><label class="check">Hà Nội<input
													type="checkbox"> <span class="checkmark"></span>
											</label></li>
											<li><label class="check">Sài Gòn<input
													type="checkbox"> <span class="checkmark"></span>
											</label></li>
									...
									<ul class="ty-product-filters" id="content_32_29">
										...
										<li>
											<ul id="ranges_32_29" class="ty-product-filters-sub">
												...
												<li><label class="check">Nguyễn Văn Hoàng<input
														type="checkbox"> <span class="checkmark"></span>
												</label></li>
												<li><label class="check">Nguyễn Hằng<input
														type="checkbox"> <span class="checkmark"></span>
												</label></li>
												<li><label class="check">Trần Dần<input
														type="checkbox"> <span class="checkmark"></span>
												</label></li>
